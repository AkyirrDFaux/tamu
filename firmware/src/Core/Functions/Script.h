...
// where service is the target ServiceType (Register).
// Static and Dynamic memory are accessed via Register service (0x01).
// ---------------------------------------------------------------------------
...
{
    // All memory access through Register service (0x01)
    if ((ServiceType)svc != ServiceType::Register) return false;
...
{
    // All memory writes through Register service (0x01)
    if ((ServiceType)svc != ServiceType::Register) return false;
